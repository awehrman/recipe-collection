...
})(["background:", ";position:fixed;top:0;width:100%;.menu-icon{color:", ";cursor:pointer;display:block;margin:10px auto;}.menu-icon:hover{color:", ";}ul{display:", ";}@media (min-width:", "){width:", ";left:-", ";bottom:0;transition:.2s ease-out;.menu-icon{top:50%;left:160px;padding:0;text-align:center;}}"], function (props) {
...
//# sourceMappingURL=_app.js.ee32b1e6107eeaa987cb.hot-update.js.map