...
})(["background:", ";position:fixed;top:0;width:100%;.menu-icon{color:", ";cursor:pointer;display:block;margin:10px auto;padding:2px;}.menu-icon:hover{color:", ";}ul{display:", ";}"], function (props) {
  return props.theme.menuBackground;
}, function (props) {
  return props.theme.menuColor;
}, Object(polished__WEBPACK_IMPORTED_MODULE_3__["lighten"])(0.2, 'props => props.theme.menuColor'), function (props) {
...
//# sourceMappingURL=_app.js.a282dbfda805a5b459c7.hot-update.js.map