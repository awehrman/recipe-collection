...
var NavStyles = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].nav.withConfig({
...
})(["background:", ";position:fixed;top:0;width:100%;.menu-icon{color:", ";cursor:pointer;display:block;margin:10px auto;}.menu-icon:hover{color:", ";}ul{display:", ";}@media (min-width:", "){width:", ";left:-", ";bottom:0;transition:.2s ease-out;.menu-icon{position:relative;left:", ";width:40px;}}"], function (props) {
  ...
  return props.theme.menuOffset / 2;
});
...
//# sourceMappingURL=_app.js.c3a2656ac3e3896db1b3.hot-update.js.map