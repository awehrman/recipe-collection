...
})(["background:", ";position:fixed;top:0;width:100%;.menu-icon{color:", ";cursor:pointer;display:block;margin:10px auto;}.menu-icon:hover{color:", ";}ul{display:", ";}@media (min-width:", "){width:", ";left:-", ";bottom:0;transition:.2s ease-out;.menu-icon{top:50%;left:160px;padding:0;text-align:center;width:40px;}}"], function (props) {
...
//# sourceMappingURL=_app.js.3c1fb98db3fac8eb78de.hot-update.js.map