...
})(["background:", ";position:fixed;top:0;width:100%;.menu-icon{color:", ";cursor:pointer;display:block;margin:0px auto;padding:10px;text-align:center;}.menu-icon:hover{color:", ";}ul{display:", ";list-style-type:none;padding:0;margin:0 20px;li{margin:20px 0;&:first-of-type{margin-top:0;}a{text-decoration:none;color:", ";font-size:.875em;font-weight:400;svg{margin-right:10px;}}}}@media (min-width:", "){width:", ";left:-", ";bottom:0;transition:.2s ease-out;.menu-icon{position:relative;left:80px;width:40px;}}"], function (props) {
...
//# sourceMappingURL=_app.js.8048aed5e6160594ee02.hot-update.js.map