...
})(["background:", ";position:fixed;top:0;width:100%;.menu-icon{color:", ";cursor:pointer;display:block;margin:0px auto;padding:10px;text-align:center;}.menu-icon:hover{color:", ";}ul{display:", ";}@media (min-width:", "){width:", ";left:-", ";bottom:0;transition:.2s ease-out;.menu-icon{position:relative;left:80px;width:40px;}}"], function (props) {
...
//# sourceMappingURL=_app.js.0e486fe1861baf2106ea.hot-update.js.map