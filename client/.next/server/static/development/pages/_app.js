...
})(["background:", ";position:fixed;top:0;width:100%;z-index:500;.menu-icon{color:", ";cursor:pointer;display:block;padding:10px;text-align:left;margin-left:10px;svg{height:16px;}&:hover{color:", ";}}ul{display:", ";list-style-type:none;padding:0;margin:0 20px;li{margin:20px 0;&:first-of-type{margin-top:0;}a{text-decoration:none;color:", ";font-size:.875em;font-weight:400;&:hover{color:", ";}svg{margin-right:10px;}}}}@media (min-width:", "){width:", ";left:-", ";bottom:0;transition:.2s ease-out;.menu-icon{position:relative;left:80px;width:40px;text-align:center;margin:0 auto;}}"], function (props) {
...
})(["position:relative;top:", ";left:0;transition:.2s ease-out;width:100%;height:100%;section{padding:20px 40px;background:white;}@media (min-width:", "){top:0;left:", ";section{margin-right:40px;}}"], function (props) {
...
/*!*************************!*\
  !*** ./lib/withData.js ***!
  \*************************/
/*! exports provided: typeDefs, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _pages_ingredients__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pages/ingredients */ "./pages/ingredients.js");
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }
...
function createClient(_ref) {
  ...
  return new apollo_boost__WEBPACK_IMPORTED_MODULE_1___default.a({
    ...
    clientState: {
      ...
      resolvers: {
        Mutation: {
          updateConfig: function updateConfig(_, _ref2, _ref3) {
            var view = _ref2.view,
                group = _ref2.group,
                isCreateEnabled = _ref2.isCreateEnabled;
            var cache = _ref3.cache;

            var _cache$readQuery = cache.readQuery({
              query: _pages_ingredients__WEBPACK_IMPORTED_MODULE_4__["LOCAL_INGREDIENTS_QUERY"]
            }),
                currentView = _cache$readQuery.currentView,
                currentGroup = _cache$readQuery.currentGroup;
          ...
          updateContainer: function updateContainer(_, variables, _ref4) {
            var cache = _ref4.cache,
                getCacheKey = _ref4.getCacheKey;
            var container = variables.container,
                ingredientID = variables.ingredientID;
            var ing;
            var fragmentId = getCacheKey({
              id: container.id,
              __typename: "Container"
            });
            var fragment = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject());
            var ctn = cache.readFragment({
              fragment: fragment,
              id: fragmentId
            }); // if we pass an ingredientID; lookup the ingredient from the cache and set it to the currentIngredientID

            if (ingredientID) {
              ing = ctn.ingredients.filter(function (i) {
        ...
        Container: {
          ...
          isCardEnabled: function isCardEnabled() {
            return false;
          },
          currentIngredientID: function currentIngredientID() {
            return null;
          }
        }
      },
      ...
      defaults: {
        currentView: 'all',
        // TODO i don't have access to this.props.query here do i?
        currentGroup: 'name',
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_lib_withData__WEBPACK_IMPORTED_MODULE_5__["default"])(RecipeApp));
