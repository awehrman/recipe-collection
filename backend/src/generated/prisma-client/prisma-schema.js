...
type ContainerSubscriptionPayload {
  mutation: MutationType!
  node: Container
  updatedFields: [String!]
...
input ContainerSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ContainerWhereInput
  AND: [ContainerSubscriptionWhereInput!]
  OR: [ContainerSubscriptionWhereInput!]
  NOT: [ContainerSubscriptionWhereInput!]
}
...
input ContainerUpdateManyMutationInput {
  currentIngredientID: ID
  isCardEnabled: Boolean
  isContainerExpanded: Boolean
  label: String
...
input ContainerWhereInput {
  ...
  id_not_ends_with: ID
  currentIngredientID: ID
  currentIngredientID_not: ID
  currentIngredientID_in: [ID!]
  currentIngredientID_not_in: [ID!]
  currentIngredientID_lt: ID
  currentIngredientID_lte: ID
  currentIngredientID_gt: ID
  currentIngredientID_gte: ID
  currentIngredientID_contains: ID
  currentIngredientID_not_contains: ID
  currentIngredientID_starts_with: ID
  currentIngredientID_not_starts_with: ID
  currentIngredientID_ends_with: ID
  currentIngredientID_not_ends_with: ID
  isCardEnabled: Boolean
...
type Mutation {
  ...
  updateContainer(data: ContainerUpdateInput!, where: ContainerWhereUniqueInput!): Container
  updateManyContainers(data: ContainerUpdateManyMutationInput!, where: ContainerWhereInput): BatchPayload!
  upsertContainer(where: ContainerWhereUniqueInput!, create: ContainerCreateInput!, update: ContainerUpdateInput!): Container!
  deleteContainer(where: ContainerWhereUniqueInput!): Container
  deleteManyContainers(where: ContainerWhereInput): BatchPayload!
...
type Query {
  ...
  containers(where: ContainerWhereInput, orderBy: ContainerOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Container]!
  containersConnection(where: ContainerWhereInput, orderBy: ContainerOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ContainerConnection!
...
type Subscription {
  ...
  container(where: ContainerSubscriptionWhereInput): ContainerSubscriptionPayload
