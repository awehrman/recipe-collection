...
export interface Exists {
  ...
  container: (where?: ContainerWhereInput) => Promise<boolean>;
...
export interface Prisma {
  ...
  container: (where: ContainerWhereUniqueInput) => ContainerPromise;
  containers: (
    args?: {
  ...
  ingredientAggregatesConnection: (
    args?: {
      where?: IngredientAggregateWhereInput;
      orderBy?: IngredientAggregateOrderByInput;
      skip?: Int;
  ...
  createContainer: (data: ContainerCreateInput) => ContainerPromise;
  updateContainer: (
    args: { data: ContainerUpdateInput; where: ContainerWhereUniqueInput }
  ) => ContainerPromise;
  ...
  deleteContainer: (where: ContainerWhereUniqueInput) => ContainerPromise;
  deleteManyContainers: (where?: ContainerWhereInput) => BatchPayloadPromise;
  ...
  updateManyIngredientAggregates: (
    args: {
...
export interface Subscription {
  ...
  container: (
    where?: ContainerSubscriptionWhereInput
  ) => ContainerSubscriptionPayloadSubscription;
  ingredient: (
...
export type ContainerOrderByInput =
  | "id_ASC"
  | "id_DESC"
  | "currentIngredientID_ASC"
  | "currentIngredientID_DESC"
  | "isCardEnabled_ASC"
  | "isCardEnabled_DESC"
  | "isContainerExpanded_ASC"
  | "isContainerExpanded_DESC"
  | "label_ASC"
  | "label_DESC"
  | "createdAt_ASC"
  | "createdAt_DESC"
...
export interface ContainerWhereInput {
  id?: ID_Input;
  id_not?: ID_Input;
  id_in?: ID_Input[] | ID_Input;
  id_not_in?: ID_Input[] | ID_Input;
  ...
  id_not_ends_with?: ID_Input;
  currentIngredientID?: ID_Input;
  currentIngredientID_not?: ID_Input;
  currentIngredientID_in?: ID_Input[] | ID_Input;
  currentIngredientID_not_in?: ID_Input[] | ID_Input;
  currentIngredientID_lt?: ID_Input;
  currentIngredientID_lte?: ID_Input;
  currentIngredientID_gt?: ID_Input;
  currentIngredientID_gte?: ID_Input;
  currentIngredientID_contains?: ID_Input;
  currentIngredientID_not_contains?: ID_Input;
  currentIngredientID_starts_with?: ID_Input;
  currentIngredientID_not_starts_with?: ID_Input;
  currentIngredientID_ends_with?: ID_Input;
  currentIngredientID_not_ends_with?: ID_Input;
  isCardEnabled?: Boolean;
  isCardEnabled_not?: Boolean;
  isContainerExpanded?: Boolean;
  isContainerExpanded_not?: Boolean;
  ...
  OR?: ContainerWhereInput[] | ContainerWhereInput;
...
export interface IngredientAggregateWhereInput {
  ...
  ingredientsCount_in?: Int[] | Int;
  ingredientsCount_not_in?: Int[] | Int;
  ...
  newIngredientsCount_in?: Int[] | Int;
  newIngredientsCount_not_in?: Int[] | Int;
  newIngredientsCount_lt?: Int;
  newIngredientsCount_lte?: Int;
  newIngredientsCount_gt?: Int;
  newIngredientsCount_gte?: Int;
  AND?: IngredientAggregateWhereInput[] | IngredientAggregateWhereInput;
  OR?: IngredientAggregateWhereInput[] | IngredientAggregateWhereInput;
  NOT?: IngredientAggregateWhereInput[] | IngredientAggregateWhereInput;
}
...
export interface ContainerUpdateManyMutationInput {
  currentIngredientID?: ID_Input;
  isCardEnabled?: Boolean;
  isContainerExpanded?: Boolean;
  label?: String;
...
export type ContainerWhereUniqueInput = AtLeastOne<{
  id: ID_Input;
}>;
...
export interface ContainerSubscriptionWhereInput {
  mutation_in?: MutationType[] | MutationType;
  updatedFields_contains?: String;
  updatedFields_contains_every?: String[] | String;
  updatedFields_contains_some?: String[] | String;
  node?: ContainerWhereInput;
  AND?: ContainerSubscriptionWhereInput[] | ContainerSubscriptionWhereInput;
  OR?: ContainerSubscriptionWhereInput[] | ContainerSubscriptionWhereInput;
  NOT?: ContainerSubscriptionWhereInput[] | ContainerSubscriptionWhereInput;
}
...
export interface AggregateContainerPromise
  extends Promise<AggregateContainer>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateContainerSubscription
  extends Promise<AsyncIterator<AggregateContainer>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}
...
export interface ContainerEdgePromise
  extends Promise<ContainerEdge>,
    Fragmentable {
  node: <T = ContainerPromise>() => T;
  cursor: () => Promise<String>;
}

export interface ContainerEdgeSubscription
  extends Promise<AsyncIterator<ContainerEdge>>,
    Fragmentable {
  node: <T = ContainerSubscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}
...
export interface ContainerSubscriptionPayload {
  mutation: MutationType;
  node: Container;
  updatedFields: String[];
  previousValues: ContainerPreviousValues;
}

export interface ContainerSubscriptionPayloadPromise
  extends Promise<ContainerSubscriptionPayload>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = ContainerPromise>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = ContainerPreviousValuesPromise>() => T;
}

export interface ContainerSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<ContainerSubscriptionPayload>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = ContainerSubscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
  previousValues: <T = ContainerPreviousValuesSubscription>() => T;
}
...
export interface ContainerPreviousValues {
  id: ID_Output;
  currentIngredientID?: ID_Output;
  isCardEnabled: Boolean;
  isContainerExpanded: Boolean;
  label: String;
}

export interface ContainerPreviousValuesPromise
  extends Promise<ContainerPreviousValues>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  currentIngredientID: () => Promise<ID_Output>;
  isCardEnabled: () => Promise<Boolean>;
  isContainerExpanded: () => Promise<Boolean>;
  label: () => Promise<String>;
}

export interface ContainerPreviousValuesSubscription
  extends Promise<AsyncIterator<ContainerPreviousValues>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  currentIngredientID: () => Promise<AsyncIterator<ID_Output>>;
  isCardEnabled: () => Promise<AsyncIterator<Boolean>>;
  isContainerExpanded: () => Promise<AsyncIterator<Boolean>>;
...
export interface ContainerConnectionPromise
  extends Promise<ContainerConnection>,
    Fragmentable {
  pageInfo: <T = PageInfoPromise>() => T;
  edges: <T = FragmentableArray<ContainerEdge>>() => T;
  aggregate: <T = AggregateContainerPromise>() => T;
}

export interface ContainerConnectionSubscription
  extends Promise<AsyncIterator<ContainerConnection>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <T = Promise<AsyncIterator<ContainerEdgeSubscription>>>() => T;
  aggregate: <T = AggregateContainerSubscription>() => T;
}
...
export interface ContainerPromise extends Promise<Container>, Fragmentable {
  id: () => Promise<ID_Output>;
  currentIngredientID: () => Promise<ID_Output>;
  isCardEnabled: () => Promise<Boolean>;
  isContainerExpanded: () => Promise<Boolean>;
...
export interface ContainerSubscription
  extends Promise<AsyncIterator<Container>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  currentIngredientID: () => Promise<AsyncIterator<ID_Output>>;
  isCardEnabled: () => Promise<AsyncIterator<Boolean>>;
